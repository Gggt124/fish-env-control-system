...
if (-not $macLine) {
    ...
    Write-Host "à¸£à¸±à¸™ SHOW_PASSWORD.bat à¸—à¸µà¸«à¸¥à¸±à¸‡à¹€à¸žà¸·à¹ˆà¸­à¸”à¸¹ password" -ForegroundColor Gray
} else {
    ...
    Write-Host "à¸–à¹‰à¸²à¸¥à¸·à¸¡: à¸£à¸±à¸™ SHOW_PASSWORD.bat (à¸•à¹‰à¸­à¸‡à¹€à¸ªà¸µà¸¢à¸š USB)" -ForegroundColor Gray
}
