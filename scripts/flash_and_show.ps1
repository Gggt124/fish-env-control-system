...
if (-not $macLine) {
    ...
    Write-Host "รัน README_password.bat ทีหลังเพื่อดู password" -ForegroundColor Gray
} else {
    ...
    Write-Host "ถ้าลืม: รัน README_password.bat (ต้องเสียบ USB)" -ForegroundColor Gray
}
