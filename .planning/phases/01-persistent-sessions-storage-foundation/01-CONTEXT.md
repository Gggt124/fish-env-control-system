...
- **D-04:** ไม่ผูกกับ IP Address หรือ User-Agent เช็คแค่ความถูกต้องของ JWT อย่างเดียว เพื่อให้ระบบเสถียรที่สุดเมื่อโทรศัพท์มือถือเปลี่ยน IP (DHCP) หรืออัปเดตระบบปฏิบัติการ
