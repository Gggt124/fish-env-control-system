...
validation:
  ...
  browser_screenshots: simulated-desktop-default-and-mobile-375-supplement
...
- Browser screenshots at explicit desktop `1440px`. The supplement now
  records the available Chrome default desktop viewport and static mobile
  baselines at `375x812`; mobile dynamic states remain deferred.
